...
";
        ...
        public MvcReportViewerIframe(
            ...
            : this(reportPath, null, null, null, null, new ControlSettings { ShowParameterPrompts = false }, htmlAttributes, FormMethod.Get)
        {
        }
        ...
        public MvcReportViewerIframe(
            ...
            IDictionary<string, object> htmlAttributes)
            : this(reportPath, null, null, null, reportParameters, new ControlSettings { ShowParameterPrompts = false }, htmlAttributes, FormMethod.Get)
        {
        }
        ...
        private string BuildIframeFormFields()
        {
            ...
            if (frameHeight != null)
            {
                ...
                _controlSettings.ShowParameterPrompts = Boolean.Parse(ConfigurationManager.AppSettings["ShowReportViewerPrompt"]);
                _controlSettings.ShowToolBar = Boolean.Parse(ConfigurationManager.AppSettings["ShowReportViewerToolbar"]);
            }

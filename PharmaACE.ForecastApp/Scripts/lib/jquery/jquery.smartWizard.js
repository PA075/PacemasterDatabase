...
function SmartWizard(target, options, finishHandler) {
    this.target       = target;
    ...
    this.buttons = {
        next : $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("btn btn-active"),
...
(function($){
    ...
    $.fn.smartWizard = function(method, finishHandler) {
        var args = arguments;
        var rv = undefined;
        var allObjs = this.each(function() {
            ...
            if (typeof method == 'object' || ! method || ! wiz) {
                ...
                if (! wiz) {
                    wiz = new SmartWizard($(this), options, finishHandler);

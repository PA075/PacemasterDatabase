function feedwind_show_widget(params, containerId, divOrder, itemOrder, caption, fdaKeyword) {
    ...
    var url = ""; //encodeURIComponent(('https:' == document.location.protocol ? 'https://' : 'http://') + 'feed.mikle.com/widget/?');
    ...
    //var caption = "";
    //var partialView = "GetFeedNews";
    //if (styleFlavor == 1) {
    //    partialView = "GetFeedNewsStatic";
    //    caption = "&caption=" + encodeURIComponent(params['rssmikle_title_sentence']);
    //}
    //if (styleFlavor == 2)
    //    partialView = "GetLatestFeedNewsStatic";
    url = window.location.protocol + "//" + window.location.host + "/LiveFeed/GetFeedNewsStatic"
        + "?url=" + encodeURIComponent(params.rssmikle_url)
        + "&divOrder=" + divOrder
        + "&item=" + itemOrder
        + "&fdaKeyword=" + fdaKeyword;
    var iframe = '<iframe ' + iframe_id_attr + iframe_height_attr + ' width="' + iframe_width + '" src="' + url + '" scrolling="' + scroll_flag
        + '" name="rssmikle_frame" marginwidth="0" marginheight="0" vspace="0" hspace="0" frameborder="0" onload="onNewsLoaded();"></iframe>';
...
function feedwind_show_widget_iframe(params, containerId) {
    params['rssmikle_frame_width'] = params['rssmikle_frame_width'] ? params['rssmikle_frame_width'] : 180;
    params['rssmikle_frame_height'] = params['rssmikle_frame_height'] ? params['rssmikle_frame_height'] : 500;
    var iframe_width = params['rssmikle_frame_width'];
    var iframe_height = params['rssmikle_frame_height'];
...
(function () {
    ...
    function old_snippet() {
        var params = {
            ...
            rssmikle_title: undef_to_nullstr(a.rssmikle_title.replace(" - Google News", "")),

...
<%--                    <span><button type="button" class="btn btn-default" data-toggle="modal" role="button" id="addDurgs1"  data-target='#addDurgs' onclick="addDrugsDetails()" >Edit Drugs</button></span>--%>
            ...
            <div class="table-responsive" id="SearchResult">
                <table  class="table table-bordered table-striped box-shadow--6dp table-hover" role="grid" aria-describedby="example_info">
                    <tr>
                        <th colspan="2">
                            <div class="display-label catlogo vbar kmBox8">
                                <div class="btbar kmBox9" id="drugsname" >
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="molecules">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="pharmaclasses">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="companynamediv">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="indicationnames">
                                ...
                                <table>
                                    <tr class="kmBox11">
                                        <td class="kmBox10">
                                            ...
                                            <button data-content="<%: Html.Raw(ADosage) %>" title="" id="dosageadultbutton" data-rel="popover" class="btn btn-default btn-xs" data-original-title="" onmousemove="popup()">Adult</button>
                                            <%} %>
                                        </td>
                                        <td class="kmBox10">
                                            <%if (Model.Dosage_Pediatric != null)
                                              { %>
                                            <button data-content="<%: Html.Raw(Model.Dosage_Pediatric) %>" title="" id="dosagepediatricbutton" data-rel="popover" class="btn btn-default btn-xs" data-original-title="" onmousemove="popup()">Pediatric</button></td>
                                        <%} %>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="formdiv">
                    ...
                    <tr>
                        <th>
                            <div class="display-label" id="startingdatediv">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="subindications">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="strenghtdiv">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-label" id="nadacpricediv">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="roadiv">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="display-field" id="moadiv">
                     ...
                     function (result) {
                         if (result.success) {
                             if (result.result == 1) {
                                 ...
                                 document.getElementById('drugsname').innerText=productname;
                                 var moldiv=document.getElementById('molecules');
                                 var hrefval= moldiv.getElementsByTagName('a')[0].href;
                                 var newhrefval=decodeURIComponent(hrefval);
                                 var moleculestring=molecule.toString();
                                 //for link add
                                 //var moleculetd='<a href="'+newhrefval +'">'+ moleculestring +'</a>';
                                 //document.getElementById('molecules').innerHTML=moleculetd;
                                 document.getElementById('molecules').innerText=moleculestring;
                                 document.getElementById('pharmaclasses').innerHTML='<span>'+pharmaclass+'</span>';
                                 document.getElementById('companynamediv').innerText=companyname;
                                 var str="";
                                 for (var i = 0; i < indication.length; i++) {
                                    str +='<span>'+indication[i]+'</span><br/>';
                                 }
                                 document.getElementById('indicationnames').innerHTML=str;
                                 document.getElementById("dosageadultbutton").setAttribute('data-content',dosageadult);
                                 document.getElementById("dosagepediatricbutton").setAttribute('data-content',dosagepediatric);
                                 document.getElementById('formdiv').innerText=form;
                                 document.getElementById('startingdatediv').innerText=startmarketingdate;
                                 document.getElementById('subindications').innerHTML=subindication;
                                 document.getElementById('strenghtdiv').innerText=strength;
                                 if (price!="") {
                                     document.getElementById('nadacpricediv').innerHTML=strength+'-$'+price+" ("+pricingunit+")";
                                 }
                                 document.getElementById('roadiv').innerText=routeofadministration;
                                 document.getElementById('moadiv').innerText=moa;
